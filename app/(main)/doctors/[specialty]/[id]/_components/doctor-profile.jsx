...
import { ChevronUp, Clock, Medal, User } from 'lucide-react'
...
const toggleBooking = () => {
  ...
  if (!showBooking) {
    // User is opening the booking form
    // You can perform any additional actions here
  setTimeout(() => {
    document.getElementById('booking-section')?.scrollIntoView({  // this is used to scroll to the booking section
      behavior: 'smooth'
    });
  }, 100);
...
const handleBookingComplete = () => {
  ...
  return ( <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="md:col-span-1">
        <div className="md:sticky md:top-24">
          <Card className="border-emerald-900/20">
            ...
            <Button onClick={toggleBooking} className='w-full mt-4 bg-emerald-600 hover:bg-emerald-700'> 
          {showBooking ? (
            <>
            Hide Booking
            <ChevronUp className='h-4 w-4 ml-2 inline-block' />
            
            </>
          ):(
          <>
            Book Appointment
            <ChevronDown className='h-4 w-4 ml-2 inline-block' />
            </>
          )}
          </Button>
   ...
   <div className='md:col-span-2 space-y-6'>
    <Card className='border-emerald-900/20'>
    <CardHeader className='bg-emerald-900/20 text-emerald-400'>
  ...
  <CardContent className="space-y-6">
            ...
            <Separator className='bg-emerald-700/10' />
