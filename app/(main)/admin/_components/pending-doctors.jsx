...
const PendingDoctors = ({doctors}) => {
    ...
    const handleViewDetails=(doctor)=>{   // Open the dialog with doctor details
 ...
 {doctors.length === 0 ? (
  ...
  <DialogContent className='max-w-4xl mx-auto'>
    <DialogHeader>
      <DialogTitle className='font-bold text-xl text-white'>Doctor Verification Details</DialogTitle>
      <DialogDescription>
       Review the doctor's information befor making a decision.
      </DialogDescription>
    </DialogHeader>
